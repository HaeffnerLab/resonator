...
class rabi_flopping(experiment):
    ...
    rabi_required_parameters = [
                               ...
                               ('RabiFlopping','beam_scan_window_range_x'),
                               ('RabiFlopping','beam_scan_window_range_y'),
                               ('RabiFlopping','beam_scan_step_size'),
                               ('RabiFlopping','beam_scan_speed'),
                                ]
    ...
    def do_get_excitation_edit(self, cxn, context, duration):
        self.load_frequency()
...
if __name__ == '__main__':
    ...
    ##### Added for Beam Addressing Scan:
    cxn_apt_motor_ctrl_station  =  labrad.connect('192.168.169.30')
    apt  =  cnx_apt_motor_ctrl_station.apt_motor_server
