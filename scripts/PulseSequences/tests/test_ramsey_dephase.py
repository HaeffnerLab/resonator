...
class test_parameters(object):
    ...
    parameters = {
                  ...
                  ('DopplerCooling', 'doppler_cooling_frequency_397'):WithUnit(220.0, 'MHz'),
                  ...
                  ('ParametricCoupling', 'drive_amplitude'):WithUnit(-10.0,'dBm'),
                  ('ParametricCoupling', 'drive_frequency'):WithUnit(10.0,'MHz'),
                  ...
                  ('SidebandCooling','sideband_cooling_detuning_729'):WithUnit(80.0, 'kHz'),
                  ...
                  ('StateReadout','state_readout_frequency_397'):WithUnit(220.0, 'MHz'),
                  ('StateReadout','state_readout_amplitude_397'):WithUnit(-13.0, 'dBm'),
                  ('StateReadout','state_readout_frequency_866'):WithUnit(80.0, 'MHz'),
                  ('StateReadout','state_readout_amplitude_866'):WithUnit(-3.0, 'dBm'),
                  ('StateReadout','state_readout_duration'):WithUnit(3.0,'ms'),
                  ('StateReadout','use_camera_for_readout'):False,
                  ('StateReadout','camera_trigger_width'):WithUnit(3.0,'us'),
                  ('StateReadout','camera_transfer_additional'):WithUnit(3.0,'us'),
                  ...
                  ('Excitation_729','rabi_excitation_duration'):WithUnit(50, 'us'),
              }
