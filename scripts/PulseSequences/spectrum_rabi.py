...
from subsequences.SwitchTrap import switch_trap
...
class spectrum_rabi(pulse_sequence):
    ...
    required_subsequences = [doppler_cooling_after_repump_d, empty_sequence, optical_pumping, 
                             rabi_excitation, tomography_readout, turn_off_all, sideband_cooling, switch_trap]
    ...
    def sequence(self):
        ...
        if p.SwitchTrap.switch_enable:
            self.addSequence(switch_trap)
